...
- Repo GitHub: https://github.com/paulatolorenzo/stelladaily (remote collegato, manca il primo push)
...
- **`"speechEndImage": "fine_discorso_speciale.png"`**: riquadro di fine discorso dedicato, preso dalla cartella della giornata al posto di quello standard (giorni 12, 13, 19 e 21).
...
Il repo locale è già inizializzato e collegato a https://github.com/paulatolorenzo/stelladaily. Manca solo il push.
...
**Attivare il sito (una volta sola):** repo → Settings → Pages → *Deploy from a branch* → main / root. URL: `https://paulatolorenzo.github.io/stelladaily/`. Il file `.nojekyll` è già presente e serve a Pages.
